...
This zip file includes a "code book" of sorts, i.e., information on the data from the entire data set, named file features_info.txt, the contents of which are in the following box, after which I will describe the data I extracted:
